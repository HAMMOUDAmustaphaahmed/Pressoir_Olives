...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 11 nov. 2025 à 16:28
...
INSERT INTO `chart` (`id`, `name`, `table_name`, `x_column`, `y_column`, `chart_type`, `created_at`, `user_id`) VALUES
(7, 'prodution', 'production', 'date_depot', 'quantite', 'line', '2025-11-11 14:41:21', 1);
...
INSERT INTO `table_metadata` (`id`, `name`, `display_name`, `created_at`) VALUES
(18, 'production', 'Production', '2025-11-11 14:38:43');
